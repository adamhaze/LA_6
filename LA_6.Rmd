...
```
##There is a strong trend between the scheduled arrival time of a flight landing in colorado and the number of flights that have also been delayed due to weather. As the scheduled arrival time increases (gets later), there is a higher chance of theflight being delayed due to weather. Also, as the distance of the flight decreases, there is another trend in higher opportunities for there being a delay in the flight due to weather. 
